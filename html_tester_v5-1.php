...
<body>
  ...
  <script>
    ...
    const CHAT_KEY = 'html-live-chat-history';
    ...
    function renderChatHistory() {
        ...
        chatHistory.forEach(msg => {
            ...
            if (msg.role === 'user') {
                ...
                div.innerHTML = `<strong style="color:var(--accent);">AI:</strong> ${escapeHtml(msg.content)}`;
            }
    ...
    function updateContextStats() {
        ...
        // You can display this in your status bar or a new UI element
        // For now, we log it to console ready for your future UI
        // console.log(`Context: ${approxTokens} tokens (${totalChars} chars)`);
    }
    ...
    document.getElementById('ai-clear-chat').addEventListener('click', () => {
        ...
        statusText.textContent = 'Context Cleared (or just chat?)';
        setTimeout(() => statusText.textContent = 'Ready', 1500);
    });
        ...
        if (isLegacyHuggingFace) {
            ...
            body = JSON.stringify({
                ...
                messages: [
                    ...
                    // CRITICAL: To enable memory, pass the chatHistory here (trimmed to last 10 msgs)
